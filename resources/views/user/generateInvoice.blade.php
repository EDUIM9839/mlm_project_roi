        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo "Invoice"; ?></li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card" >
                ...
                <div class="title-action">
                    <a class="btn btn-large btn-primary" title="Partial Payment" onclick="printDiv('printableArea')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M16 8.615v-3H8v3H7v-4h10v4zm-11.423 1h14.846zm13.038 2.5q.425 0 .713-.287t.287-.713q0-.425-.287-.712t-.713-.288q-.425 0-.712.288t-.288.712q0 .425.288.713t.712.287M16 19v-4.538H8V19zm1 1H7v-4H3.577v-5.385q0-.85.577-1.425t1.423-.575h12.846q.85 0 1.425.575t.575 1.425V16H17zm2.423-5v-4.385q0-.425-.287-.712t-.713-.288H5.577q-.425 0-.713.288t-.287.712V15H7v-1.538h10V15z"/></svg></a>
             
                </div>
            <!-- Header -->
            <div id="printableArea" width="900">
            
            <table width="100%" border="0"  style='margin-top:10px;' cellpadding="0" cellspacing="0" align="center" class="fullTable" bgcolor="#e1e1e1">
              <tbody>
                <tr>
                  <td>
                            ...
                            <table width="800" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                              <tbody>
                                ...
                                <?php
                                    ...
                                    $total_amount=$row['mrp']-$totalgst;
                                    $totals=($total_amount-($row['mrp']*$products['0']->percent_discount)/100)*$row['quantity'];
                                    $grandtotal=$totals+(($perquantityDiscount*$cgst)/100)*$row['quantity']+(($perquantityDiscount*$sgst)/100)*$row['quantity']+(($perquantityDiscount*$igst)/100)*$row['quantity'];
                                    $subtotal+=$totals;
                                ...
                                <tr>
                                  ...
                                  <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align:center">
                                       <?php echo $data['0']->currency_symbol;?>&nbsp;<?php echo $total_amount; ?>
                                  </td>
                                    <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align:center">
                                   ...
                                   <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align:center">
                                      <?php echo $data['0']->currency_symbol;?>&nbsp;<?php echo $totals; ?>
                                  </td>
                                   <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align:center">
                                  ...
                                  <td>
                                    ...
                                    <table width="250" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                                      <tbody>
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top;;">
                                                 <img src='<?php echo url("/")?>/storage/app/<?php echo $data[0]->e_sign;?>' width='300'>
                                            </td>
                                        </tr>
