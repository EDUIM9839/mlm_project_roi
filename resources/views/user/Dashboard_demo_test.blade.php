		...
		<div class="row row-cols-1 row-cols-md-3 row-cols-xl-12 g-3 px-3">
	        ...
	        @if(count($topEarners) > 0)
                <div class="col-md-3">
                    ...
                    <div class="card-body">
                        @if(isset($topEarners[0]))
                            <div class="d-flex align-items-center gap-2 p-2 mb-2 rounded-2 shadow-sm text-white" style="background-color:#FFD700;">
                                <div>
                                    
                                    <img src="{{ $topEarners[0]->image ? asset('storage/' . $topEarners[0]->image) : asset('assets/images/theme/ranks/1s.png') }}" class="rounded-circle" width="32" height="32">
                                </div>
                                <div class="small text-dark fw-bold">
                                    <div>{{ ucfirst(strtolower($topEarners[0]->first_name)) }} {{ ucfirst(strtolower($topEarners[0]->last_name)) }}</div>
                                    <div class="text-muted">ID: {{ $topEarners[0]->userid ?? '0' }}</div>
                                </div>
                            </div>
                        @endif
                        @if(isset($topEarners[1]))
                            <div class="d-flex align-items-center gap-2 p-2 mb-2 rounded-2 shadow-sm text-white" style="background-color:#C0C0C0;">
                                <div>
                                    <img src="{{ $topEarners[1]->image ? asset('storage/' . $topEarners[1]->image) : asset('assets/images/theme/ranks/2s.png') }}" class="rounded-circle" width="32" height="32">
                                </div>
                                <div class="small text-dark fw-bold">
                                    <div>{{ ucfirst(strtolower($topEarners[1]->first_name)) }} {{ ucfirst(strtolower($topEarners[1]->last_name)) }}</div>
                                    <div class="text-muted">ID: {{ $topEarners[1]->userid ?? '0' }}</div>
                                </div>
                            </div>
                        @endif
                        @if(isset($topEarners[2]))
                            <div class="d-flex align-items-center gap-2 p-2 mb-2 rounded-2 shadow-sm text-white" style="background-color:#CD7F32;">
                                <div>
                                    <img src="{{ $topEarners[2]->image ? asset('storage/' . $topEarners[2]->image) : asset('assets/images/theme/ranks/3s.png') }}" class="rounded-circle" width="32" height="32">
                                </div>
                                <div class="small text-dark fw-bold">
                                    <div>{{ ucfirst(strtolower($topEarners[2]->first_name)) }} {{ ucfirst(strtolower($topEarners[2]->last_name)) }}</div>
                                    <div class="text-muted">ID: {{ $topEarners[2]->userid ?? '0' }}</div>
                                </div>
                            </div>
                        @endif
                    </div>
            ...
            @else
                <div class="col-md-3">
                    ...
                    <div class="card-body">
                        <div class="no-data text-danger fw-bold">No winners for last week.</div>
                    </div>
                    </div>
                </div>
            @endif
                ...
                <div class="row">
                                ...
                                <div class="col-6 col-md-4 col-lg-3 p-0 px-1">
                                    <div class="card m-0 p-0 my-1 position-relative">
                                            <div class="card-body p-0 m-0 mb-2 text-center">
                                                ...
                                                {{-- <span class="badge bg-success ms-2 fw-normal" style="font-size:12px; margin-top:5px;">{{ $info->create_date }}</span> --}}
                                            </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="mt-2">
                            ...
                            <span class="badge bg-success" style="font-size:12px;text-wrap:unset">{{count($lottery_weeks)}}</span>
                        </div>
