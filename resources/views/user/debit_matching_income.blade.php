        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Debit Matching Income</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2">
					...
					<div class="col">
                                     ...
                                     <table class="table table-bordered">
                                         <tr>
                                             ...
                                             <td>
                                                 ...
                                                 {{$user->first_name}} {{$user->last_name}}</br><b>{{$user->userid}}</b></td>
                                             <th>Amount</th>
                                      ...
                                      @else
                                               @if($d->credit_status=="pending")
                                                	<button type="button" class="btn btn-outline-success px-5 mb-1" onclick="show_payment({{$user->id}})">Pay</button>
						...
						<div class="col" style='display:none;' id="form">
						<div class="card radius-15">
							<div class="card-body">
								<div class="p-4 border radius-15">
								    <form method="post" action="{{route('pay_matching_income')}}" enctype='multipart/form-data'>
								        @csrf()
