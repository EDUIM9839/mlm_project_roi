...
.website-footer{
    ...
    display:block;font-weight:bold; font-size:0.8rem; padding-top:0.062rem;
}
        ...
        <div class="page-content">
            ...
            <div    class="col-sm-10 col-md-10 panel" >
                      ...
                      <div class="welcome-letter" class="mt-5 d-flex" >
                       ...
                       <div style="display:block;" align="center"> <img src="{{ Storage::url('app/logo/').DB::table('business_setup')->first()->logo}}" class="logo-icon1" alt="logo icon"> <br>
  </div>
                       <!--<h3 align="center" class="name"><span  class="company-name" ></span></h3>-->
                          ...
                          <div class="col-md-12" align="center">
                             <img src="{{ Storage::url('app/profileupload/').Auth::user()->image}}" class="logo-icon1 " alt="logo icon"> 
                                <!--<img     src="{{ Storage::url('app/profileupload/').Auth::user()->image}}" class="user-img" alt="user avatar" width="100" height="auto" >-->
                                  ...
                                  {{Auth::user()->first_name}}  {{Auth::user()->last_name}}
                                    ...
                                    <b style="color:green; font-size:10px;" >
                                       ...
                                       <span  class="sticky website-footer" style="text-transform:uppercase"   align="center";>
                                           @php
                                        $company=DB::table('business_setup')->first()->web_url ;
                                        @endphp
                                         {{$company}}
                                       </span>
                      </div>  
          ...
          <div style="display:block;" align="center">
              <a>
                 <img src="https://mlmlaravel.swasoftech.in/public/assets/images/downloadbutton.gif"width=200px; onclick="CreatePDFfromHTML();" alt="logo"style="cursor: pointer;"> 
              </a> <br>
  </div>
            <!--/ Scrollable -->
