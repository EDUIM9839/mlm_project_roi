...
@section('mains')
    ...
    <div class="page-wrapper">
        <div class="page-content">
               <h6 class="mb-0 text-uppercase alert">Weaker Leg Business</h6>
       <hr/>
             ...
             <tbody>
                                ...
                                @foreach ($data['team'] as $d)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{Helper::get_currency()}}{{ $d['self_business'] }}</td>
                                        <td>{{Helper::get_currency()}}{{ $d['team_business'] }}</td>
                                        <td>{{Helper::get_currency()}}{{ $d['self_business'] + $d['team_business'] }}</td>
