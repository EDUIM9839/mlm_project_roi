...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <!--<div class="ms-auto">-->
            <!--    <div class="btn-group">-->
            <!--        <a href="{{route('products')}}" type="button" class="btn btn-primary"><i-->
            <!--                class="lni lni-arrow-left-circle"></i> Product</a>-->
            <!--    </div>-->
            <!--</div>-->
            	@php
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Product Details Summary</h5>
                <hr>
                <div class="form-body mt-4">
                  ...
                  <form action="{{route('pay_from_wallet')}}" method="post">
                      @csrf()
                    <div class="row">
                        <div class="col-lg-5">
                        ...
                        <div class="col-lg-7">
                            <div class="border border-3 p-4 rounded">
                                            ...
                                            <div class="row g-0">
                                                <div class="col-md-12">
                                                    ...
                                                    <p class="mb-0 ms-auto">{{$da[0]->rating}}</p>
                                                        ...
                                                        <dt class="col-sm-12">Quantity : {{$d->quantity}}</dt>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <input type="hidden" name="total_bv" value="{{$bv}}" class="form-control">
                                
                                    <div class="row">
                                    <div class="col-md-6"><h4 class="card-title">Total: {{Helper::get_currency()}} {{$total}}</h4></div>
                                    <div class="col-md-6"><h4 class="card-title">Total: {{$bv}} BV</h4></div>
                                        <hr>
                                      <h4 class="card-title">Payment</h4>
                                      <h6 class="card-title">Wallet Amount: {{Helper::get_currency()}} {{$user->saving_wallet}}</h6>
                                      @if($total>=($user->saving_wallet))
