        ...
        <div class="page-content">
            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2">
                                @php
                                    $i = 1;
                                @endphp
                                @if(!empty($matching_income[0]))
                                @foreach ($matching_income as $d)
                                @php
                                     ...
                                     <table class="table table-bordered">
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 ...
                                                 @php 
                                                 $counter_date=date("M d, Y H:i:s",strtotime('+1 days',strtotime($d->date_time)))
                                                 @endphp
                                                 <p id="demo{{$d->id}}"></p>
						...
						<div class="card radius-15">
							<div class="card-body text-center">
								<div class="p-2 border radius-15">
									...
									<h5 class="mb-0 mt-5">You don't have enough team right now to get <b>Matching income</b>, <span style="color:red;"><i>Binary Circle</i></span> hopes that  you will recieve this income soon...</h5>
									<p class="mb-3"></p>
