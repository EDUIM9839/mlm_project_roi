                ...
                <div class="card-body p-4">
					...
					<div class="border p-4 rounded">
						<div class="row g-3 ">
                             ...
                             <div class="col-md-6">
                                            <label for="inputLastName2" class="form-label">Authorized E-Sign</label>
                                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                            class='bx bxs-image'></i></span>
                                            <input type="file" class="form-control border-start-0"
                                            value="{{ $bs->e_sign }}" name="e_sign" id="e_sign"
                                            placeholder="Fav Icon" />
                                            </div>
                                            <span style="color:red;">{{$errors->first('e_sign')}}</span> 
                                             <img src="{{ Storage::url('app/logo/').$bs->e_sign}}" class='mt-3' style="width:100px;float:right;">
                                        </div>
                        </div>
					</div> 
