    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class='col-md-6'>
                       <h6 class="mb-0 text-uppercase" style='float:right;'> <a href="{{route('add-product')}}" class='badge bg-info'>Add Franchise</a></h6>
                </div>
                </div>
            </div>
            <!--end breadcrumb-->
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;">{{ $d->franchise_owner_name }}<br>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;">{{ $d->franchise_name }}</td>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;">
                                            <a href="{{ route('edit-franchise', ['id'=>$d->id]) }}">
                                                <i class="fa fa-edit" title="Edit" style="font-size:15px"></i>
                                            </a>
                                            <a href="{{ route('delete-franchise', ['id'=>$d->id])}}">
                                                <i class="fa fa-trash" title="Delete" style="font-size:15px"></i>
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
