...
<body>
	 ...
	 <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div style='margin-left: 75px'>
                    <img src="{{ Storage::url('app/logo/').DB::table('business_setup')->first()->logo}}" style="width:75px">
                ...
                <!--</div>-->
                <div class="toggle-icon ms-auto"><i  hre="javescripte:;"class='bx bx-arrow-back'></i>
                </div>
            </div>
            <!--navigation-->
            <ul class="metismenu" id="menu">
                ...
                <a href="javascript:;" class="has-arrow" aria-expanded="false">
                     <div class="parent-icon"><i class='bx bx-user-circle'></i>
						...
						<div class="menu-title"> Income Setting</div>
                   </a>
                    <ul>
                    <li><a   href="{{route('direct-income-setting-page')}}"> <i class='bx bx-radio-circle'></i> Direct Income </a></li>
                    <li><a   href="{{route('level_income_setting')}}"><i class='bx bx-radio-circle'></i> Level Income </a></li>
                ...
                <li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">ID Card Setting</div>
					</a>
					<ul>
						 
						<!--<li> <a href="{{route('welcome_letter_setting')}}"><i class='bx bx-radio-circle'></i>Theme</a>-->
						<!--</li>-->
						<li> <a href="{{route('idcard_setting')}}"><i class='bx bx-radio-circle'></i>Theme</a>
						</li>
						<li> <a href="{{route('welcome_content')}}"><i class='bx bx-radio-circle'></i>Content</a>
						</li>
    ...
    <!--            	<li>-->
				...
				<!--</li>-->
				<!--				<li>-->
				<!--	<a href="{{route('welcome_letter_setting')}}">-->
				<!--		<div class="parent-icon"><i class="lni lni-briefcase"></i>-->
				<!--		</div>-->
				...
				<li>
                    ...
                    <a href="{{route('tree-setting-page')}}">
                        <div class="parent-icon"><i class='lni lni-vector'></i>
                        </div>
                        <div class="menu-title">Tree Setting</div>
                    </a>
                </li>
                <li>
                <a href="javascript:;" class="has-arrow" aria-expanded="false">
                   ...
                   <li>
					...
					<a href="{{route('website_setting')}}">
						...
						<div class="menu-title">Website Themes</div>
					</a>
				</li>
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Side Background Theme</div>
					</a>
					<ul>
						 
						<li> <a href="{{route('loginimage')}}"><i class='bx bx-radio-circle'></i>Login Image Upload</a>
						</li>
						<li> <a href="{{route('background_login')}}"><i class='bx bx-radio-circle'></i>Admin Login Background Themes</a>
						</li>
							<li> <a href="{{route('user_background')}}"><i class='bx bx-radio-circle'></i>User Login Background Themes</a>
						</li>
						 <li> <a href="{{route('register_background')}}"><i class='bx bx-radio-circle'></i>Register Login Background Themes</a>
						</li>
						<li> <a href="{{route('forget_background')}}"><i class='bx bx-radio-circle'></i>Forget Login Background Themes</a>
						</li>
						 					</ul>
				</li>
