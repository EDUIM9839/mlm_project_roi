						...
						<div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <?php if(!empty($data['0']->id)){?>
                                        <input type="text" class="form-control" value="{{ $data['0']->franchise_name }}" name="franchise_name" placeholder="Enter Franchise Name" id="franchise_name">
                                    <?php } else{ ?>
                                        <input type="text" class="form-control" name="franchise_name"  value="{{ old('franchise_name') }}" placeholder="Enter Franchise Name" id="franchise_name">
                                    <?php } ?>   
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                                class='bx bxs-user'></i></span>
                                    <?php if(!empty($data['0']->id)){?>
                                        <input type="text" class="form-control" value="{{ $data['0']->franchise_owner_name }}" name="franchise_owner_name" placeholder="Enter Owner Name" id="franchise_owner_name">
                                    <?php } else{ ?>
                                        <input type="text" class="form-control" value="{{ old('franchise_owner_name') }}" name="franchise_owner_name" placeholder="Enter Owner Name" id="franchise_owner_name">   
                                    <?php } ?>    
                                    
                                    @error('franchise_owner_name')
                                        <small style="color:red">{{ $message }}</small>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <?php 
                                     ...
                                     <input type="text" class="form-control" readonly='readonly' value="{{  $data['0']->franchise_name }}" name="pfranchise"  id="pfranchise">
                                       
                                    <?php } else{ ?>
                                        <select class="form-control" id="pfranchise" name="pfranchise" >
                                            <option value="">--Select--</option>
                                             @foreach($allfranchise as $franchises)
                                                 <option value="{{ $franchises->id }}">{{ $franchises->franchise_name }}</option>
                                             @endforeach
                                        </select>
