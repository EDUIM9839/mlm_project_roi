                            ...
                            <tbody>
                                ...
                                @foreach ($data as $datas)
                                    <tr>
                                        ...
                                        <td>{{$datas->contact}}</td>
                                        <td>{{Helper::get_currency()}} {{$datas->withdrawl_wallet}}</td>
                                        <td>{{Helper::get_currency()}} {{$datas->saving_wallet}}</td>
                                        <td>{{$datas->referal}}</td>
