            ...
            <!--end breadcrumb-->
              <div class="w-100 p-2 mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="fs-4 fw-bold">Id Card Themes</div>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#uploadThemeModal"><i
     ...
     <div class="modal fade" id="uploadThemeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('id_card_save') }}" method="post" enctype='multipart/form-data'>
