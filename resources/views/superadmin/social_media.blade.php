            ...
            <div class="card border-top border-0 border-4 border-white">
							<div class="card-body p-2">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-black">Social Media</h5><hr/>
								<!--  -->
								<div>
							</div>
								<!--  -->
                    ...
                    <form class="row g-3" action="{{route('update_social')}}" method="POST">
						@csrf
									<div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control border-start-0"  name="name" id="name" placeholder="Mailer Name" />
                                                <!-- 										
									...
									<div class="col-md-6">
										...
										<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bxs-inbox'></i></span>
											<input type="text" class="form-control border-start-0"  name="social_url" id="social_url" placeholder="Ex:https://facebook.com/c/xa****/***" />
										</div>
									</div>
