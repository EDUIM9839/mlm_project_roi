				...
				<div class="container">
					<div class="main-body">
						<div class="row">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											<img src="{{ Storage::url('app/profileupload/').$user_details['0']->image}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
											<div class="mt-3">
                            ...
                            <td>{{Helper::get_currency()}} {{$user_details['0']->withdrawl_wallet }}</td> 
                                                                      </tr>
                                                                      <tr>
                                                                          <th>Status</th>
                      ...
                      <div class="card radius-10">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<div>
									<h6 class="mb-0">Team Overview</h6>
								</div>
						  ...
						  <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-0 row-group text-center border-top">
							<div class="col">
							  <div class="p-3">
								...
								<small class="mb-0">This Week direct user <span> <i class="bx bx-up-arrow-alt align-middle"></i> 0</span></small>
							  </div>
							</div>
							<div class="col">
							  <div class="p-3">
