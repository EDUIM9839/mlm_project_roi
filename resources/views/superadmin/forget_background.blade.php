    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Forget Login Side Background Theme</li>
                        </ol>
                    </nav>
                </div> 
            </div>
            ...
            <div    class="col-sm-10"  id="smallscreen">
                                      ...
                                      <!-- Scrollable -->
                                       <form action="{{route('forgets')}}" method="post" enctype="multipart/form-data">
				                    	@csrf
