...
@php
    $themes = DB::table('login_theme')->get();
@endphp
...
<body>
    <div class="container" style="box-shadow: -1px 0px 10px 3px rgb(255 229 229) !important;border-radius: 20px;!important" >
        ...
        <img  style="left: 30px; margin-top: 15px; width: 101px;" class="swa_logo" src="{{ storage::url('app/logo/') . $business_settings['0']->fav_icon }}" width="160px" alt="SWA Logo">
        ...
        <div class="forms">
            <div class="form-content">
                <div class="login-form">
                    ...
                    <div class="title mb-4 text-white" id='board-title'>Admin Login </div>
                    ...
                    <form action="{{ route('admin-validate') }}" id="login-form" method="post">
                        @csrf
                        <div class="input-boxes">
                            ...
                            <div class="mt-2 d-flex justify-content-between">
                                ...
                                <div class="text"><a href="{{ route('forget-password') }}" class="text-small text-white" id="forgotpassword">Forgot
                                        password?</a></div>
                            </div>
                            ...
                            <div class="button input-box">
                              ...
                              <div class="my-3">
                                <a href="{{ route('login') }}" class="text-secondary w-100 d-flex align-items-center p-2 justify-content-center text-white">
