                        ...
                        <table class="table dataTable no-footer" id="example" aria-describedby="example_info">  
                            ...
                            <tbody>
                                    ...
                                    @php
                                     ...
                                     @php $tuser=DB::table('user')->where('id', $d->user_id)->get(); @endphp
                                     @php $fuser=DB::table('user')->where('id', $id)->get(); @endphp
                                 
                                    <tr>
                                        
                                        <td class='textcenter'>{{$i++}}</td>
                                        <td class='textcenter'>{{$fuser['0']->first_name}}</td>
                                        <td class='textcenter'>{{$tuser['0']->first_name}}</td>
                                        <!--<td class='textcenter'>{{Helper::get_currency()}}&nbsp;{{$d->total}}</td>-->
                                        <td class='textcenter'>{{$d->payment_methods}}</td>
                                        <td class='textcenter'>{{$d->order_id}}</td>
                                        <td class='textcenter'>{{$d->created_date}}</td>
                                        ...
                                        <td class='textcenter'>
                                            <div class="btn-group">
                                                        ...
                                                        <a href="{{route('purchase_invoice', ['id'=>$d->id])}}" target="_blank" style='font-size: 25px;'>
                                                            ...
                                                            <div class="modal-dialog modal-lg">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @php $j = 1;$jdata=json_decode($d->products, 1) @endphp
