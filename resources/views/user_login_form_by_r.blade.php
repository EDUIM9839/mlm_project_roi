...
<head>
 ...
 <style>
     * {
     ...
     .login__wrapper {
         background: lightblue  url({{ Storage::url('app/public/pc.png')}}) no-repeat fixed 32%; background-size:60% 50% ;
     ...
     .login__cta {
         background-color: hsla(var(--hue), 10%, 90%, 0);
         
         -webkit-backdrop-filter: blur(24px);
         /*box-shadow: 0 -0.75em 1.5em rgba(0, 0, 0, 0.05), 0 1px 0 rgba(255, 255, 255, 0) inset;*/
         border-radius: 0;
         color: white;
         flex: 1;
         margin: 0 -1.5em;
...
<body  style="background: lightblue  url({{ Storage::url('app/public/cover-login2.jpg')}}) no-repeat fixed center; background-size:100% 100% ;" >
 <svg display="none">
 ...
 <form class="login" method="post" action="{{ route('login-validate') }}">
     @csrf
     <div class="login__wrapper" style="">
