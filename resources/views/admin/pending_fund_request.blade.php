            ...
            <div class="card">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                       <button class="fund-request image-opener-button" id="view-proof-of-payment" data-bs-whatever="{{$d->user_id}}" data-bs-target="#proof-of-payment-image">
                       <img id="img"  src="{{ Storage::url('app/profileupload/').$d->proof_of_payment}}" style= "border:1px outset; width: 50px; height: 50px; position: relative;"></button>
                       </a>
                     </td>
                     <td>
                  ...
                  <p  class="badge bg-gradient-quepal text-white shadow-sm w-50">Paid</p>
                     @else
                     <a onclick="geteditid({{$d->id}});"  data-bs-toggle="modal" data-bs-target="#exampleModal"><button class="btn btn-info">Pay</button></a>
                     
                    <a href="{{ route('delete-pending', ['id' => $d->id]) }}" class="delete-btn ms-3">
