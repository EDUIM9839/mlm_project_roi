                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style="font-size: 12px; font-family: 'Open Sans', sans-serif;line-height: 18px;  vertical-align: top; padding:10px 0;width:110px" class="article">
                                   ...
                                   &nbsp;&nbsp;<small style=' color: #ff0000; '><?php  echo $products['0']->percent_discount;echo "%";echo ' ';  echo "OFF" ?></small>
                                    @elseif(!empty($products['0']->flat_discount))
                                      &nbsp;&nbsp;<small style=' color: #ff0000; '><?php  echo $products['0']->flat_discount;echo "";echo ' ';  echo "OFF" ?></small>
                                      @else
                                      @endif
                                  </td>
                                  ...
                                  <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align:center">
                                       <?php echo $data['0']->currency_symbol;?>&nbsp;<?php echo $row['mrp']; ?>
                                  </td>
                                    <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align:center">
                                  ...
                                  <td>
                                    ...
                                    <table width="250" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td style="font-size: 11px; text-align: center; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 1; vertical-align: top; algin:right; ">
