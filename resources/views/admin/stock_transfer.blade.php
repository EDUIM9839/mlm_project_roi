            ...
            <form id='myform' enctype='multipart/form-data'>
                ...
                <div>
                      ...
                      <div class="position-relative input-icon">
							<input type="text" class="form-control" onkeyup="search_franchise();" onchange="search_franchise();"   <?php if(!empty($user['0']->id)){?> value='{{$user["0"]->franchise_name}}' <?php } ?> onmousedown="search_franchise();"  autocomplete='off'   name="customer" id="customer">
                  ...
                  <table class="table">
                     ...
                     <tbody id="tablerow">
                        ...
                        <tr>
                            ...
                            <td style="text-align:center"><a onclick="decreaseqty('{{$rows['id']}}')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>-</span></a><input name="quantity" style="width:50px" type="text" min="1" value="{{$rows['quantity']}}" id="" readonly ><a onclick="increaseqty('{{$rows['id']}}')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>+</span></a></td>
               ...
               <div style="margin-top:10px;" id='countinue_sale'>
                  ...
                  <input type="button"  onclick="uploadFranchise();" style="float:right;" class="btn btn-primary"  class="fixed-bottom" value="Continue Sale">
               </div>
               <?php } else { ?>
...
<script>
                ...
                if(data==0){
                 ...
                 $('.hidestockspan'+id).css('display', 'none');
                    ...
                    '<td style="text-align:center">'+value.name+'</td>'+
                     '<td style="text-align:center">'+'<a onclick="decreaseqty('+value.id+')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>-</span></a><input name="quantity" style="width:50px" type="text" min="1" value="'+value.quantity+'" id="quantity'+value.id+'" readonly ><a onclick="increaseqty('+value.id+')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>+</span></a>'+'</td>'+
    ...
    function update_Qty(id){
            ...
            success: function (data) {
                    ...
                    '<td style="text-align:center">'+value.name+'</td>'+
                    '<td>'+'<a onclick="decreaseqty('+value.id+')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>-</span></a><input name="quantity" style="width:50px;background-color:#e7e7e7" type="text" min="1" value="'+value.quantity+'" id="quantity'+value.id+'" readonly ><a onclick="increaseqty('+value.id+')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>+</span></a>'+'</td>'+
                    '<td style="text-align:center">'+value.mrp+'</td>'+
                    '<td style="text-align:center">'+dp+'</td>'+
                    '<td style="text-align:center">'+total+'</td>'+
                    '<td style="text-align:center">'+total_bv+'</td>'+
                 ...
                 var cdata = JSON.stringify(data['cartdata']);
                  ...
                  var result  ='';
                    ...
                    '<tr>'+
                     '<td style="text-align:center">'+i+'</td>'+
                    '<td style="text-align:center">'+value.name+'</td>'+
                    '<td style="text-align:center">'+'<a onclick="decreaseqty('+value.id+')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>-</span></a><input name="quantity" style="width:50px;background-color:#e7e7e7" type="text" min="1" value="'+value.quantity+'" id="quantity'+value.id+'" readonly ><a onclick="increaseqty('+value.id+')" class="btn btn-md" style="height: 26px;background-color:#e7e7e7"><span>+</span></a>'+'</td>'+
                    '<td style="text-align:center">'+value.mrp+'</td>'+
                    '<td style="text-align:center">'+dp+'</td>'+
                    '<td style="text-align:center">'+total+'</td>'+
                    '<td style="text-align:center">'+total_bv+'</td>'+
