	...
	<div class="wrapper">
	 ...
	 <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <!--</div>-->
                <div class="toggle-icon ms-auto"><i  hre="javescript:;"class='bx bx-arrow-back'></i>
                </div>
            </div>
    ...
    <!--                <img src="{{ Storage::url('app/logo/').DB::table('business_setup')->first()->logo}}" class="logo-icon" alt="logo icon">-->
            ...
            <ul class="metismenu" id="menu">
                ...
                <a href="javascript:;" class="has-arrow" aria-expanded="false">
                    ...
                    <ul>
                    <li><a   href="{{route('user-list')}}"> <i class='bx bx-radio-circle'></i>    User list</a></li>
                    <li><a   href="{{ route('active_user_list') }}"><i class='bx bx-radio-circle'></i>Active User List</a></li>
