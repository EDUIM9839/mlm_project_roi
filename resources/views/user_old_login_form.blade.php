...
<head>
    ...
    <link href="{{asset('assets/css/icons.css')}}" rel="stylesheet">
      <title>{{$business_settings['0']->business_name}}-User Login</title>
</head>
                ...
                <div class="row g-0">
                    ...
                    <div
                        ...
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
                            <div class="card-body">
                                <img src="{{asset('assets/images/login-images/mehaimagemlm.png')}}"
                                    class="img-fluid auth-img-cover-login" width="100%" alt="" />
                            </div>
                        </div>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    <div class="mb-3 text-center">
                                        ...
                                        <img style="border-radius:18px; width:30%;" src="/storage/app/logo/{{$business_settings['0']->logo}}" style="width:100px">
                                    </div>
                                     <div class="login-wrapper__top text-center">
                                        <h4 style="color:white;" class="title">Welcome to <strong>{{$business_settings['0']->business_name}}</strong></h4>
                                        <h5 style='color:white;'  class="text-decoration-underline">User Login</h5>
                                    </div>
                                ...
                                @endif
                                     ...
                                     <div class="form-body" style='margin-top:80px'>
                                        <form class="row g-3" action="{{route('login-validate')}}" method="POST">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group"  style='font-size:16px' id="show_hide_password">
                                    ...
                                    <!--<div class="login-separater text-center"> <span><a class="badge rounded-pill bg-danger" style='font-size:12px;' href="{{route('admin-login')}}">ADMIN LOGIN</a></span>-->
                                    <hr>
                                    <!--<div class="login-separater text-center"> <span><a class="badge rounded-pill bg-success" style='font-size:12px;' href="{{route('franchise-login')}}">FRANCHISE LOGIN</a></span>-->
                                    <!--<hr>-->
                                    <!--</div> -->
