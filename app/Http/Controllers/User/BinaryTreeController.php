...
$send_data=compact('final_tree','tree_setting','direct_this_id','direct_upline_userids','main_star_user','max_levels');



return view('user.binary-tree')->with($send_data);
